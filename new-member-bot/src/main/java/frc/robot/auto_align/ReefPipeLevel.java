...
public enum ReefPipeLevel {
  ...
  L1(new Transform2d(-Units.inchesToMeters(14.5 + 4.0 + 2.0), 0.0, Rotation2d.kZero)),
  L2(new Transform2d(-Units.inchesToMeters(14.5 + 4.0 + 2.0), 0.0, Rotation2d.kZero)),
  ...
  BACK_AWAY_AUTO(new Transform2d(-Units.inchesToMeters(14.5 + 4.0 + 2.0), 0.0, Rotation2d.kZero));
