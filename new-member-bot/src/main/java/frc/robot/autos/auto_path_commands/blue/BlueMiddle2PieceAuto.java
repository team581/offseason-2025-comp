...
public class BlueMiddle2PieceAuto extends BaseCommandAuto {
  ...
  public Pose2d getStartingPose() {
    return Points.START_MIDDLE_BARGE.point.bluePose();
  }
    ...
    return Commands.sequence(
        ...
        trailblazer.followSegment(
            new AutoSegment(
                ...
                new AutoPoint(new Pose2d(5.85, 4.077, Rotation2d.fromDegrees(180))))),
        ...
        trailblazer.followSegment(
            new AutoSegment(
                AutoBlocks.BASE_CONSTRAINTS,
                new AutoPoint(new Pose2d(6.15, 4.077, Rotation2d.fromDegrees(180))))),
        ...
        trailblazer.followSegment(
            new AutoSegment(
                AutoBlocks.BASE_CONSTRAINTS,
                new AutoPoint(new Pose2d(6.432, 4.05, Rotation2d.fromDegrees(180))))),
        // Score first algae
        trailblazer.followSegment(
            new AutoSegment(
                AutoBlocks.BASE_CONSTRAINTS,
        ...
        trailblazer.followSegment(
            new AutoSegment(
                AutoBlocks.BASE_CONSTRAINTS,
                new AutoPoint(new Pose2d(7.15, 6.1, Rotation2d.fromDegrees(0))))),
        autoCommands.netReleaseCommand(),
        Commands.waitSeconds(0.8),
        trailblazer.followSegment(
            new AutoSegment(
                AutoBlocks.BASE_CONSTRAINTS,
                new AutoPoint(new Pose2d(7.05, 6.1, Rotation2d.fromDegrees(0))))),
        Commands.waitSeconds(0.5),
