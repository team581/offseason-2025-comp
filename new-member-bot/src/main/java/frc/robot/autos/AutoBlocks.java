...
public static final PoseErrorTolerance APPROACH_REEF_TOLERANCE = new PoseErrorTolerance(0.6, 10);
  ...
  public AutoBlocks(
      Trailblazer trailblazer, RobotManager robotManager, AutoCommands autoCommands) {
        ...
        trailblazer.followSegment(
            new AutoSegment(
                ...
                new AutoPoint(
                    ...
                    BASE_CONSTRAINTS),
                new AutoPoint(
                    () -> pipe.getPose(ReefPipeLevel.RAISING), BASE_CONSTRAINTS),
                new AutoPoint(
                    () -> pipe.getPose(ReefPipeLevel.RAISING),
                ...
                new AutoPoint(
                    () -> pipe.getPose(ReefPipeLevel.L1), SCORING_CONSTRAINTS))),
        trailblazer.followSegment(
            new AutoSegment(
                BASE_CONSTRAINTS,
  ...
  public Command scoreL1(
      Pose2d approachPose, ReefPipe pipe, Pose2d backupPoint) {
