...
public class OdometryTest {
  ...
  private static final SwerveDriveKinematics kinematics = new SwerveDriveKinematics(robotRelativeModulePositions);

  @Test
  void testStraightLineDrive() {
    var start = new SwerveModulePosition[] {
    ...
    var end = new SwerveModulePosition[] {
