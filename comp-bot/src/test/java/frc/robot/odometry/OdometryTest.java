...
//   // FOR ALL TESTS BELOW:
//   // -The name indicates modules start direction to end direction, in relation to the unit circle.
//   // For example Test upToRight() indicates starting at pi radians(pointing up on unit circle), then
...
//   // circumfrence of a circle with raius 1. This is for simplicity so that all end points will be
//   // (±1, ±1)
