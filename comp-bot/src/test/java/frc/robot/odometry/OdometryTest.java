...
public class OdometryTest {
  ...
  var customOdometry = new CustomOdometry(
  ...
  var actual = customOdometry.update(new Rotation2d(0.0), new SwerveModulePosition[] {
    new SwerveModulePosition(0.0, new Rotation2d(0.0)),
    new SwerveModulePosition(0.0, new Rotation2d(0.0)),
    new SwerveModulePosition(0.0, new Rotation2d(0.0)),
    new SwerveModulePosition(0.0, new Rotation2d(0.0))
  ...
  // FOR ALL TESTS BELOW:
  // -The name indicates modules start direction to end direction, in relation to the unit circle. For example Test upToRight() indicates starting at pi radians(pointing up on unit circle), then travelling on an arc ending at pi / 2 radians(pointing right on unit circle)
  // -Tests will have the previous robot pose at (0, 0, 0) for simplicity
  // -Tests will have modules end distance as 2.0 * pi / 4.0 to represent a fourth of the circumfrence of a circle with raius 1. This is for simplicity so that all end points will be (±1, ±1)
