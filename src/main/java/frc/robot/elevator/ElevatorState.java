...
public enum ElevatorState {
  ...
  LOLLIPOP_CORAL_INTAKE_APPROACH(0.0),
  LOLLIPOP_CORAL_INTAKE_INTAKE(0.0),
  LOLLIPOP_CORAL_INTAKE_TILT(20.0),

  ALGAE_INTAKE_GROUND(10.95),
  ...
  ALGAE_NET_LEFT(50.0),
  ALGAE_NET_RIGHT(50.0),

  PROCESSOR(4.0),

  // Left coral positions
  CORAL_SCORE_LEFT_LINEUP_L2(14.2),
  CORAL_SCORE_LEFT_RELEASE_L2(14.2),

  CORAL_SCORE_LEFT_LINEUP_L3(25.0),
  CORAL_SCORE_LEFT_RELEASE_L3(25.0),

  CORAL_SCORE_LEFT_LINEUP_L4(51.0),
  CORAL_SCORE_LEFT_RELEASE_L4(51.0),

  // Right coral positions
  CORAL_SCORE_RIGHT_LINEUP_L1(0.0),
  CORAL_SCORE_RIGHT_RELEASE_L1(0.0),

  CORAL_SCORE_RIGHT_LINEUP_L2(14.2),
  CORAL_SCORE_RIGHT_RELEASE_L2(14.2),

  CORAL_SCORE_RIGHT_LINEUP_L3(25.0),
  CORAL_SCORE_RIGHT_RELEASE_L3(25.0),

  CORAL_SCORE_RIGHT_LINEUP_L4(51.0),
  CORAL_SCORE_RIGHT_RELEASE_L4(51.0),
