...
public class RedLollipopRightL4Auto extends BaseAuto {
  public RedLollipopRightL4Auto(RobotManager robotManager, Trailblazer trailblazer) {
    ...
    return Commands.sequence(
        ...
        timing.time(
            ...
            blocks.intakeLollipop(
                new Pose2d(15.7, 4.05, Rotation2d.fromDegrees(0))
