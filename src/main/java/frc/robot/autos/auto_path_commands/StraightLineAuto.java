        ...
        Commands.runOnce(
            () ->
                robotManager.localization.resetPose(
                    new Pose2d(10.263, 0.748, Rotation2d.fromDegrees(0)))),
        trailblazer.followSegment(
            new AutoSegment(
                CONSTRAINTS,
                new AutoPoint(new Pose2d(10.263, 0.748, Rotation2d.fromDegrees(0))),
                new AutoPoint(new Pose2d(11.924, 0.748, Rotation2d.fromDegrees(0))))),
        trailblazer.followSegment(
            new AutoSegment(
                CONSTRAINTS,
                new AutoPoint(new Pose2d(13.313, 0.748, Rotation2d.fromDegrees(0))),
                new AutoPoint(new Pose2d(14.928, 0.748, Rotation2d.fromDegrees(0))))));
  }
}
