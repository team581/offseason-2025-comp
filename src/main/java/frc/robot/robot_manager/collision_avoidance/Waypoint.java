...
public enum Waypoint {
  ...
  L2_RIGHT(new SuperstructurePosition(14.2, 25.0)),
  L3_RIGHT(new SuperstructurePosition(25.0, 25.0)),
  L4_RIGHT(new SuperstructurePosition(51.0, 32.0)),
  L2_LEFT(new SuperstructurePosition(14.2, 180.0 - 25.0)),
  L3_LEFT(new SuperstructurePosition(25.0, 180.0 - 25.0)),
  L4_LEFT(new SuperstructurePosition(51.0, 180.0 - 32.0)),
