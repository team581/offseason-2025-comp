...
public enum ReefPipeLevel {
  ...
  L1(
      new Transform2d(-0.60, 0, Rotation2d.fromDegrees(90)),
      new Transform2d(-0.60, 0, Rotation2d.fromDegrees(270))),
  L2(
      new Transform2d(-0.60, 0, Rotation2d.fromDegrees(90)),
      new Transform2d(-0.60, 0, Rotation2d.fromDegrees(270))),
  L3(
      ...
      new Transform2d(-0.60, 0, Rotation2d.fromDegrees(270))),
  L4(
      new Transform2d(-0.64635, 0, Rotation2d.fromDegrees(90)),
      new Transform2d(-0.64635, 0, Rotation2d.fromDegrees(270)));
