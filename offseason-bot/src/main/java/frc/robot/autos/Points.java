...
public enum Points {
  ...
  START_R1_AND_B1(Point.ofRed(new Pose2d(10.289, 0.47, Rotation2d.fromDegrees(90.0)))),
  ...
  START_R6_AND_B6(Point.ofRed(new Pose2d(10.289, 7.58, Rotation2d.fromDegrees(90.0)))),

  GROUND_INTAKE_NON_PROCESSOR_SIDE_STATION(
      Point.ofRed(new Pose2d(16.117, 0.922, Rotation2d.fromDegrees(126.0)))),
  PRE_GROUND_INTAKE_NON_PROCESSOR_SIDE_STATION(
      Point.ofRed(new Pose2d(14.9, 1.7, Rotation2d.fromDegrees(126.0)))),

  GROUND_INTAKE_PROCESSOR_SIDE_STATION(
      Point.ofRed(new Pose2d(16.117, 7.078, Rotation2d.fromDegrees(234.0)))),
  PRE_GROUND_INTAKE_PROCESSOR_SIDE_STATION(
      Point.ofRed(new Pose2d(14.9, 6.3, Rotation2d.fromDegrees(234.0)))),

  LOLLIPOP_2(Point.ofRed(new Pose2d(16.8, 4.0, Rotation2d.fromDegrees(180.0))));
