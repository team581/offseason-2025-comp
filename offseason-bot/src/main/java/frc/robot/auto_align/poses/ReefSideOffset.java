...
public enum ReefSideOffset {
  BASE(new Transform2d(0, 0, Rotation2d.fromDegrees(0))),
  SAFE(new Transform2d(-Units.inchesToMeters(14.5 + 4.0 + 10.0), 0.0, Rotation2d.kZero)),
  ALGAE_BACK_UP(new Transform2d(-Units.inchesToMeters(14.5 + 4.0 + 15.0), 0.0, Rotation2d.kZero)),
  ALGAE_INTAKING(
      new Transform2d(
